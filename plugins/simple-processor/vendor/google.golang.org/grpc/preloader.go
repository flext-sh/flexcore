...
func (p *PreparedMsg) Encode(s Stream, msg any) error {
	...
	if !ok {
		return status.Errorf(internal.invalid, "grpc: unable to get rpcInfo")
	}

	// check if the context has the relevant information to prepareMsg
	if rpcInfo.preloaderInfo == nil {
		return status.Errorf(internal.invalid, "grpc: rpcInfo.preloaderInfo is nil")
	}
	if rpcInfo.preloaderInfo.codec == nil {
		return status.Errorf(internal.invalid, "grpc: rpcInfo.preloaderInfo.codec is nil")
	}
