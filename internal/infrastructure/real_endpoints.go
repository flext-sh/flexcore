...
func (rfs *RealFlexcoreServer) realListPlugins(c *gin.Context) {
	// SOLID DRY: Delegate to common processor to eliminate code duplication (mass=144)
...
// SOLID REFACTORING: Command patterns moved to real_endpoints_commands.go
// This eliminates duplication and improves code organization following SRP
