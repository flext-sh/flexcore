...
└── Description: ALGAR Oracle User Directory migration
```
...
├── Branch: heads/main
├── Organization: datacosmos-br (original)
└── Description: GrupoNOS POC OIC-WMS integration

gruponos-meltano-native/
├── Repository: https://github.com/flext-sh/gruponos-meltano-native.git
├── Commit: eec30240b053af721124059062bbb4c56c8cb5e7
├── Branch: heads/main
├── Organization: flext-sh (migrated)
└── Description: GrupoNOS native Meltano implementation
```
